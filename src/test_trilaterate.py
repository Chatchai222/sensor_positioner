...
class TestPosition(unittest.TestCase):
    ...
    def test_givenTwoPositionWithSmallDistance_thenPositionIsAlmostEqual(self):
        ...
        pos1 = trilaterate_algorithm.Position(10, 20, 30)
        pos2 = trilaterate_algorithm.Position(10.00001, 19.9999, 30.0003)
        pos3 = trilaterate_algorithm.Position(9.99999, 20.00001, 29.99999)
    ...
    def test_givenTwoPositionWithSameCoordinate_thenEqualityOperatorReturnTrue(self):
        pos1 = trilaterate_algorithm.Position(10, 20, 30)
        pos2 = trilaterate_algorithm.Position(10, 20, 30)
...
class TestFarAxisOrigin2DPositionCalculator(unittest.TestCase):
    ...
    def setUp(self):
        self.pos_calculator = trilaterate_algorithm.FarAxisOrigin2DPositionCalculator()

    def test_givenEmptyList_whenGetPosition_thenRaiseMissingOriginPosition(self):
        self.assertRaises(trilaterate_algorithm.FarAxisOrigin2DPositionCalculator.MissingOriginPositionException, self.pos_calculator.get_position, [])
        

    def test_givenMissingOriginPosition_whenGetPosition_thenRaiseMissingOriginPosition(self):
        many_tag_dist_to_anchor_pos = [ 
            (math.sqrt(66), trilaterate_algorithm.Position(22, 0, 0)),
            (math.sqrt(67), trilaterate_algorithm.Position(0, 22, 0)),
            (math.sqrt(342), trilaterate_algorithm.Position(0, 0, 22)),
            (math.sqrt(22), trilaterate_algorithm.Position(32, 12, 23)),
        ]
    ...
    def test_givenMissingFarXPosition_whenGetPosition_thenRaiseMissingFarXPosition(self):
        many_tag_dist_to_anchor_pos = [ 
            (math.sqrt(66), trilaterate_algorithm.Position(0, 0, 0)),
            (math.sqrt(67), trilaterate_algorithm.Position(0, 22, 0)),
            (math.sqrt(342), trilaterate_algorithm.Position(0, 0, 22)),
            (math.sqrt(22), trilaterate_algorithm.Position(32, 12, 23)),
        ]
    ...
    def test_givenMissingFarYPosition_whenGetPosition_thenRaiseMissingFarYPosition(self):
        many_tag_dist_to_anchor_pos = [ 
            (math.sqrt(66), trilaterate_algorithm.Position(0, 0, 0)),
            (math.sqrt(67), trilaterate_algorithm.Position(13, 0, 0)),
            (math.sqrt(342), trilaterate_algorithm.Position(0, 0, 22)),
            (math.sqrt(22), trilaterate_algorithm.Position(32, 12, 23)),
        ]
    ...
    def test_givenCompleteData_returnCorrectPosition(self):
        tag_dist_to_anchor_pos_and_anchor_pos = [
            (math.sqrt(318), trilaterate_algorithm.Position(0, 0, 0)), # origin
            (math.sqrt(230), trilaterate_algorithm.Position(22, 0, 0)), # far x
            (math.sqrt(267), trilaterate_algorithm.Position(0, 3, 0)), # far y
        ]
        expected_tag_position = trilaterate_algorithm.Position(13, 10, 0)
